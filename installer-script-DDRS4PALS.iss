...
UninstallDisplayIcon            = {#SourcePath}\res\DDRS4PALS.ico
WizardImageFile                 = {#SourcePath}\res\DDRS4PALS.bmp
WizardImageStretch              = no
OutputDir                       = {#SourcePath}
OutputBaseFilename              = {#MyOutputBaseFilename}
SetupIconFile                   = {#SourcePath}\res\DDRS4PALS.ico
Compression                     = lzma
...
Source: "{#SourcePath}\exe\DQuickLTFit.exe"; DestDir: {app}; Flags: ignoreversion;
...
Source: "{#SourcePath}\exe\bin\libeay32.dll"; DestDir: {app}; Flags: ignoreversion
...
Source: "{#SourcePath}\exe\bin\Qt5Concurrent.dll"; DestDir: {app}; Flags: ignoreversion
...
Source: "{#SourcePath}\exe\bin\Qt5Network.dll"; DestDir: {app}; Flags: ignoreversion
Source: "{#SourcePath}\exe\bin\Qt5PrintSupport.dll"; DestDir: {app}; Flags: ignoreversion
Source: "{#SourcePath}\exe\bin\Qt5Script.dll"; DestDir: {app}; Flags: ignoreversion
...
Source: "{#SourcePath}\exe\bin\ssleay32.dll"; DestDir: {app}; Flags: ignoreversion
...
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\DQuickLTFit"; Filename: "{app}\DQuickLTFit.exe"; Tasks: quicklaunchicon

[UninstallDelete]
Type: files; Name: "{app}\{#MyAppExeName}.exe"
Type: files; Name: "{app}\DQuickLTFit.exe"
...
Filename: "{#MyAppURL}"; Description: "visit DDRS4PALS homepage ..."; Flags: postinstall shellexec unchecked;
